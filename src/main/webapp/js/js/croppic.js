...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		createImgUploadControls: function(){
			...
			var html =    '<div class="cropControls cropControlsUpload" style="display: none"> ' + cropControlUpload + cropControlRemoveCroppedImage + ' </div>';
		...
		bindImgUploadControl: function(){
            ...
            var formHtml = '<form class="' + that.id + '_imgUploadForm" hidden>  <input type="file" name="backgroundFile" id="' + that.id + '_imgUploadField">  </form>';
