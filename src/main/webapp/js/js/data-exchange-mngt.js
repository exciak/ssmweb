            ...
            function(data,status){
                if(data.result != "success"){
                    ...
                    if(data.successTimes != ""){
                        $(obj).append('<a href="javascript:void(0);" onclick=\'exchangeRecord("'+$(obj).data("exchangeid")+'")\'>成功 '+ data.successTimes+'次<br>失败 '+ data.failTimes+' 次</a>');
                    }else{
...
function exchangeRecord(exchangeId){
